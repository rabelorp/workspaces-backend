...
export class Rabelodigital1728509714958 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "locker" ("activate" boolean NOT NULL DEFAULT true, "lockerName" character varying NOT NULL, "locationId" uuid NOT NULL, "photoId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_295c0898cceea20ac8ee103d98d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bf24d81f063aa2ed2644bf46e2" ON "locker" ("locationId") `);
        await queryRunner.query(`CREATE TYPE "public"."locker_reservation_reservationtime_enum" AS ENUM('1', '2', '3')`);
        await queryRunner.query(`CREATE TYPE "public"."locker_reservation_reservationstatus_enum" AS ENUM('1', '2', '3')`);
        await queryRunner.query(`CREATE TABLE "locker_reservation" ("reservationDate" date NOT NULL, "observation" text, "reservationTime" "public"."locker_reservation_reservationtime_enum" NOT NULL DEFAULT '1', "userId" uuid NOT NULL, "reservationStatus" "public"."locker_reservation_reservationstatus_enum" NOT NULL DEFAULT '2', "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "lockerId" uuid NOT NULL, CONSTRAINT "PK_8530da9d60094ce6381b2997d73" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f226cdbce69ba0dd975ddd104d" ON "locker_reservation" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0921b73c4f3920de33ede469c7" ON "locker_reservation" ("lockerId") `);
        ...
        await queryRunner.query(`CREATE TABLE "session" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "hash" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid NOT NULL, CONSTRAINT "PK_f55da76ac1c3ac420f444d2ff11" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "work_station_reservation" ("lockerReservationId" uuid, "reservationStatus" "public"."work_station_reservation_reservationstatus_enum" NOT NULL DEFAULT '2', "observation" text, "userId" uuid NOT NULL, "reservationTime" "public"."work_station_reservation_reservationtime_enum" NOT NULL DEFAULT '1', "reservationDate" date NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "workStationId" uuid NOT NULL, CONSTRAINT "PK_bb374aa5663e752d4fc5e7968ad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_ec79a7059b30e3c59d015e5051" ON "work_station_reservation" ("lockerReservationId") `);
        ...
        await queryRunner.query(`CREATE TABLE "garage_reservation" ("lockerReservationId" uuid, "vehiclePlate" character varying(7) NOT NULL, "reservationStatus" "public"."garage_reservation_reservationstatus_enum" NOT NULL DEFAULT '2', "userId" uuid NOT NULL, "observation" text, "reservationTime" "public"."garage_reservation_reservationtime_enum" NOT NULL DEFAULT '1', "reservationDate" date NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "garageId" uuid NOT NULL, CONSTRAINT "PK_4fb93ec0b90af373a7636dee190" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b54472211803f15bb98daf5118" ON "garage_reservation" ("lockerReservationId") `);
        ...
        await queryRunner.query(`ALTER TABLE "locker" ADD CONSTRAINT "FK_bf24d81f063aa2ed2644bf46e22" FOREIGN KEY ("locationId") REFERENCES "location"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "locker_reservation" ADD CONSTRAINT "FK_f226cdbce69ba0dd975ddd104da" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "locker_reservation" ADD CONSTRAINT "FK_0921b73c4f3920de33ede469c73" FOREIGN KEY ("lockerId") REFERENCES "locker"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "room_reservation" ADD CONSTRAINT "FK_842298d8cbd4ef75f879535b13c" FOREIGN KEY ("lockerReservationId") REFERENCES "locker_reservation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "work_station_reservation" ADD CONSTRAINT "FK_ec79a7059b30e3c59d015e50516" FOREIGN KEY ("lockerReservationId") REFERENCES "locker_reservation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "garage_reservation" ADD CONSTRAINT "FK_b54472211803f15bb98daf5118a" FOREIGN KEY ("lockerReservationId") REFERENCES "locker_reservation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "garage_reservation" DROP CONSTRAINT "FK_b54472211803f15bb98daf5118a"`);
        ...
        await queryRunner.query(`ALTER TABLE "work_station_reservation" DROP CONSTRAINT "FK_ec79a7059b30e3c59d015e50516"`);
        ...
        await queryRunner.query(`ALTER TABLE "room_reservation" DROP CONSTRAINT "FK_842298d8cbd4ef75f879535b13c"`);
        await queryRunner.query(`ALTER TABLE "locker_reservation" DROP CONSTRAINT "FK_0921b73c4f3920de33ede469c73"`);
        await queryRunner.query(`ALTER TABLE "locker_reservation" DROP CONSTRAINT "FK_f226cdbce69ba0dd975ddd104da"`);
        await queryRunner.query(`ALTER TABLE "locker" DROP CONSTRAINT "FK_bf24d81f063aa2ed2644bf46e22"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b54472211803f15bb98daf5118"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ec79a7059b30e3c59d015e5051"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_842298d8cbd4ef75f879535b13"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0921b73c4f3920de33ede469c7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f226cdbce69ba0dd975ddd104d"`);
        await queryRunner.query(`DROP TABLE "locker_reservation"`);
        await queryRunner.query(`DROP TYPE "public"."locker_reservation_reservationstatus_enum"`);
        await queryRunner.query(`DROP TYPE "public"."locker_reservation_reservationtime_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bf24d81f063aa2ed2644bf46e2"`);
