...
export class Rabelodigital1725652208970 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "room" RENAME COLUMN "location" TO "locationId"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "room" DROP COLUMN "locationId"`);
    await queryRunner.query(
      `ALTER TABLE "room" ADD "locationId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "room" RENAME COLUMN "locationId" TO "location"`,
    );
  }
}
