...
export class Rabelodigital1726084495068 implements MigrationInterface {
    name = 'Rabelodigital1726084495068'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "garage_reservation" ("vehiclePlate" character varying(7) NOT NULL, "reservationStatus" "public"."garage_reservation_reservationstatus_enum" NOT NULL DEFAULT '2', "userId" integer NOT NULL, "observation" text, "reservationTime" "public"."garage_reservation_reservationtime_enum" NOT NULL DEFAULT 'integral', "reservationDate" TIMESTAMP NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "garageId" uuid, CONSTRAINT "PK_4fb93ec0b90af373a7636dee190" PRIMARY KEY ("id"))`);
