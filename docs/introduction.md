...
- Frontend (React, Next.js): <https://git.rabelodigital.com.br/fabrica/rabelodigital/frontend.git>
- Backend (Node, Nest.js): <https://git.rabelodigital.com.br/fabrica/rabelodigital/backend.git>
- Mobile (React Native): <https://git.rabelodigital.com.br/fabrica/rabelodigital/mobile.git>
